...
member_engagement_fiscal$Eng_Level <- as.factor(member_engagement_fiscal$Eng_Level)

# Default is alphabetically ordering
member_engagement_fiscal <- within(member_engagement_fiscal, age_category[age_category=="J"] <- "A-Junior")
member_engagement_fiscal <- within(member_engagement_fiscal, age_category[age_category=="I"] <- "B-Intermediate")
member_engagement_fiscal <- within(member_engagement_fiscal, age_category[age_category=="S"] <- "C-Senior")
...
#
## Alluvial Plot
ggplot(member_engagement_fiscal,
       aes(x = age_category,
           stratum = Eng_Level,
